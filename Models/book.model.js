...
const seedBookData = () => {
    ...
    let new_book3 = new bookModel({
        ...
        description: 'n the year 1984, civilization has been damaged by world war, civil conflict, and revolution. Airstrip One (formerly known as Great Britain) is a province of Oceania, ',
        email: 'sajamalkawai@gmail.com',
        status: 'avilable'
    })
    new_book3.save();
...
module.exports = { bookModel, seedBookData }